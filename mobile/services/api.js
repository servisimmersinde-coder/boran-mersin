...
const API_URL = Platform.select({
  android: __DEV__ ? 'http://10.0.2.2:3000/api' : 'https://boran-mersin.onrender.com/api',
  ios: __DEV__ ? 'http://localhost:3000/api' : 'https://boran-mersin.onrender.com/api',
  default: __DEV__ ? 'http://localhost:3000/api' : 'https://boran-mersin.onrender.com/api'
});
